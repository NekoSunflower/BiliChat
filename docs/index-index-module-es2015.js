...
let ChatRendererComponent = class ChatRendererComponent {
    constructor(plat) {
        this.plat = plat;
    ...
    sendSystemInfo(msg, force = false) {
...
ChatRendererComponent.ctorParameters = () => [
...
let ChatRendererModule = class ChatRendererModule {
};
...
let LegacyPaidMessageComponent = class LegacyPaidMessageComponent {
...
LegacyPaidMessageComponent.ctorParameters = () => [
...
let IndexComponent = class IndexComponent {
    ...
    ngAfterViewInit() {
        ...
        this.http.get(`${_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].api_server}/history`).subscribe(resp => {
            this.entrys = resp;
        });
        ...
        let g = new _danmaku_def__WEBPACK_IMPORTED_MODULE_6__["GiftMessage"](109402, '绊爱厨', '小电视', 2, 1245000, 0, {
